	    ...
	    void *fdata, LMstat *lmstat)
{
  ...
  double *h=malloc(sizeof (double) *npar*npar);
  double *ch=malloc(sizeof (double) *npar*npar);

   double *g=malloc(sizeof (double) * npar);
   double *d=malloc(sizeof (double) * npar);
   double *delta=malloc(sizeof (double) * npar);
   double *newpar=malloc(sizeof (double) * npar);
